...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 30 16:05:10 2019
...
reset_logger('logger_spell_0x00000001.log')
logger_spell = setup_logger('logger_spell', 'logger_spell_0x00000001.log')
...
for i in range(n_media_interations):
    ...
    for j in range(n_point_interations):
        ...
        logger_spell.info('Acuracia = {0}'.format(mac))
        logger_spell.info("Matriz de confusao \n{0}".format(str(mcm)))
